...
from authentication.views import AccountViewSet, LoginView, LogoutView, ProfileCodeLoginView
from app.views import AdminUserView, EndUserView, ItemView, RatingView, RecommendationView, CSSTemplateView, CSVUploadView, \
RepoTableView, AuthCodeToAccessTokenView
...
urlpatterns = [
    ...
    url(r'^api/v1/css/$', CSSTemplateView.as_view(), name='css'),
    url(r'^api/v1/css/(?P<pk>[^/]+)/$', CSSTemplateView.as_view(), name='css'),
